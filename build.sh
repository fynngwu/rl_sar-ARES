...
rm -f "$HOME/.local/bin/ares" "$HOME/.local/bin/ares_driver_node" "$HOME/.local/bin/test_onnx_smoke" "$HOME/.local/bin/test_driver_feedback"
cp src/rl_sar/build/bin/ares src/rl_sar/build/bin/ares_driver_node src/rl_sar/build/bin/test_onnx_smoke src/rl_sar/build/bin/test_driver_feedback "$HOME/.local/bin/"

echo ""
echo "=== Build complete ==="
echo "  ~/.local/bin/ares              # RL inference node"
echo "  ~/.local/bin/ares_driver_node   # Hardware driver node"
echo "  ~/.local/bin/test_onnx_smoke    # ONNX smoke test"
echo "  ~/.local/bin/test_driver_feedback # Motor feedback test"
